...
考虑这样的一种排序问题：我们无法准确知道待排序的数字是什么，但对于每一个数，我们知道它属于实数轴上的某个区间。也就是说，我们得到了n个形如[ai, bi]的闭区间，其中ai <= bi。我们的目标是实现这些区间的模糊排序，即对于j = 1, 2, 3, ..., n，生成一个区间的排列<i1, i2, i3, ..., in>，且存在cj∈[aij, bij]，满足c1 <= c2 <= ... <= cn。
