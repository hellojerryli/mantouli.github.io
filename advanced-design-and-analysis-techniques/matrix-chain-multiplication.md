...
1. (A<sub>1</sub>(A<sub>2</sub>(A<sub>3</sub>A<sub>4</sub>)))  
2. (A<sub>1</sub>((A<sub>2</sub>A<sub>3</sub>)A<sub>4</sub>))  
3. ((A<sub>1</sub>A<sub>2</sub>)(A<sub>3</sub>A<sub>4</sub>)  
4. ((A<sub>1</sub>(A<sub>2</sub>A<sub>3</sub>))A<sub>4</sub>)  
