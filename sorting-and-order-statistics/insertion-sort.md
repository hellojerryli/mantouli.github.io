...
在分析插入排序时，我们既研究了最坏情况，又研究了最好情况，然而，在实际中，我们往往集中于只求最坏情况运行时间，即对于规模为 n 的输入，算法的最长运行时间。下面给出这样做的三个理由：
...
在某些特定的情况下，我们会对一个算法的平均情况运行时间感兴趣，例如快速排序。使用随机化算法，它做出一些随机的处理，以允许进行概率分析并产生某个期望运行时间。
